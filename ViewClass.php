<html>
    <head><title>View Class</title></head>
...
<body>
        ...
        <table>
            <tr>
                ...
                <th width="250px">Class Subject<br><hr></th>
                <th width="250px">Capacity<br><hr></th>
                <th width="250px">Room Number<br><hr></th>
            </tr>
<?php

$sql = mysqli_query($link,"SELECT ClassID,ClassName,Capacity,RoomNumber FROM classes");
