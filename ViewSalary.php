<html>
    <head><title>View Salary</title></head>
...
<body>
        ...
        ?>
        <h3>View all Salaries:</h3>
        <table>
            <tr>
                <th width="100px">Salary ID<br><hr></th>
                <th width="250px">Teacher ID<br><hr></th>
                <th width="300px">Salary (£)<br><hr></th>
                <th width="300px">Class <br><hr></th>
            </tr>
<?php

$sql = mysqli_query($link,"SELECT SalaryID,TeacherID,Salary,ClassName FROM salary");
