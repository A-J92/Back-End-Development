<html>
    <head><title>Add Salary</title></head>
...
<body>
    ...
    <body>
        <h1>Add Salary</h1>
        <form name="myForm" method="post" action="AddSalary.php"  onsubmit="return validateForm()">
...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO salary (TeacherID,Salary,ClassName) VALUES('$TeacherID','$Salary','$ClassName')";
