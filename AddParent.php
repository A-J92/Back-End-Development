...
<body>
        ...
        <input type="PNumber" name="v3"><br>
        <br>
        <label>Student Relation </label>
        <input type="StudentRelation" name="v4"><br>
        <?php
...
if(isset($_POST['submit']))
{
    ...
    $ParentName = $_POST['v2'];
    $PNumber = $_POST['v3'];
    $StudentRelation = $_POST['v4'];
 
    $sql = "INSERT INTO parent (ParentID,ParentName,PNumber,StudentRelation) VALUES('$ParentID','$ParentName','$PNumber','$StudentRelation')";
