...
<body>
    ...
    function validateFormA()
    {
        ...
        <form name="myForm" method="post" action="UpdateStudent.php"  onsubmit="return validateForm()">
        ...
        <br>
        <label>Address </label>
        <input type="Address" name="u4"><br><br>
...
if(isset($_POST['submit']))
{
    ...
    $sql = "UPDATE student SET StudentName ='$StudentName', Email ='$Email', Address ='$Address', ParentID ='$ParentID'
